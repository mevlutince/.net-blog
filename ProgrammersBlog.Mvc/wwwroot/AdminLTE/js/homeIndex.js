$(document).ready(function () {
    ...
    $.get('/Admin/Article/GetAllByViewCount/?isAscending=false&takeSize=10',/*metodun bekledigi parametreler*/
        function(data) {
            ...
            let viewCountChart = new Chart(viewCountContext,
                {
                    type: 'bar',
                    data: {
                        labels: articleResult.$values.map(article => article.Title), /*map foreach görevi yapıyor*/
                        datasets: [
                            {
                                label: 'Okunma Sayısı',
